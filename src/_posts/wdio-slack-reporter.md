---
title: WebdriverIO Slack Reporter 만들기
date: '2021-12-08'
...
<img src="https://raw.githubusercontent.com/morooLee/wdio-slack-reporter/master/docs/Notification.png" width="80%" height="80%" title="Notification Image" alt="Notification">
...
||emojiSymbols||**type**: `Object`<br />**scope**: `webhook`, `web-api`<br />**default**: <br /><Blockquote>**passed** - :white_check_mark:<br />**failed** - :x:<br />**skipped** - :double_vertical_bar:<br />**pending** - :grey_question:<br />**start** - :rocket:<br />**finished** - :checkered_flag:<br />**watch** - :stopwatch:</Blockquote>This option changes the emoji set by default.|
